...
var _default = {
  ...
  getDistances: function getDistances(lat1, lng1, lat2, lng2) {
    ...
    var radLat1 = lat1 * Math.PI / 180.0; //lat1 * Math.PI / 180.0=>弧度计算
...
var router = (0, _uniSimpleRouter.createRouter)({
  platform: "mp-weixin",
  routes: (0, _toConsumableArray2.default)([{"path":"/pages/index/index","aliasPath":"/"},{"path":"/pages/seek/seek"},{"path":"/pages/my/my"},{"path":"/pages/userPolicy/userPolicy"},{"path":"/pages/privacyAgreements/privacyAgreements"},{"path":"/pages/feedBack/feedBack"},{"path":"/pages/chat/chat"}])
});
exports.router = router;
var nextArr = ["/pages/my/my", "/pages/feedBack/feedBack", "/pages/privacyAgreements/privacyAgreements", "/pages/userPolicy/userPolicy"];
var isNext = false;
